...
i64 TARGET_V1 llvm_fptosi_sat_i64_float(float) __asm__("llvm.fptosi.sat.i64.f32");
...
i64 TARGET_V1 llvm_fptosi_sat_i64_double(double) __asm__("llvm.fptosi.sat.i64.f64");
